...
public class CustomGuideMultiTarget extends FrameLayout {
    ...
    private CustomGuideMultiTarget(Context context, View view) {
        super(context);
    ...
    public static class Builder {
        ...
        public CustomGuideMultiTarget build() {
            CustomGuideMultiTarget guideView = new CustomGuideMultiTarget(context, targetView);
