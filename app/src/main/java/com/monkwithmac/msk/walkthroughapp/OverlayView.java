...
public class OverlayView extends FrameLayout {
    ...
    private void addCustomView(View view){
        addView(view, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, android.view.Gravity.CENTER));
    }
    ...
    public static class Builder {
        ...
        /**
         * add custom view on overlay
         *
         * @param view you can add custom view on overlay
         */
        ...
        public OverlayView build() {
            OverlayView guideView = new OverlayView(context);
